...
require (
	...
	go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.46.0 // indirect; / indirect
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracehttp v1.46.0 // indirect; / indirect
	go.opentelemetry.io/otel/exporters/zipkin v1.46.0 // indirect; / indirect
